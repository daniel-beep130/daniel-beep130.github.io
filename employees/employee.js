...
// define an object using constructor funtion
function Employee(name, title, phone)
{
    ...
    this.title = title;
    this.phone = phone;
    //assign method to the employee obaject
...
empArray = empArray.sort();  //built-in sort function sorts letters not numbers
